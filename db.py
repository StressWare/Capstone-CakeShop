...
loyalty_gifts = db.collection("loyalty_gifts")
pending_consultations = db.collection("pending_consultations")
webauthn_credentials = db.collection("webauthn_credentials")
login_logs = db.collection("login_logs")